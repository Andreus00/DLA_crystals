...
./bin/ymodel --scene tests/04_grass/grass.json --output outs/04_grass/grass.json --grassbase object --grass grass --part_num 1000
./bin/yscene render --scene outs/04_grass/grass.json --output out/04_grass_1.jpg --samples 25 --resolution 720 --bounces 128

./bin/ymodel --scene tests/04_grass/grass.json --output outs/04_grass/grass.json --grassbase object --grass grass --part_num 4000
./bin/yscene render --scene outs/04_grass/grass.json --output out/04_grass_2.jpg --samples 25 --resolution 720 --bounces 128

./bin/ymodel --scene tests/04_grass/grass.json --output outs/04_grass/grass.json --grassbase object --grass grass --part_num 8000
./bin/yscene render --scene outs/04_grass/grass.json --output out/04_grass_3.jpg --samples 25 --resolution 720 --bounces 128

./bin/ymodel --scene tests/04_grass/grass.json --output outs/04_grass/grass.json --grassbase object --grass grass --part_num 12000
./bin/yscene render --scene outs/04_grass/grass.json --output out/04_grass_4.jpg --samples 25 --resolution 720 --bounces 128

./bin/ymodel --scene tests/04_grass/grass.json --output outs/04_grass/grass.json --grassbase object --grass grass --part_num 16000
./bin/yscene render --scene outs/04_grass/grass.json --output out/04_grass_5.jpg --samples 25 --resolution 720 --bounces 128
